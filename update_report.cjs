...
export const ReportsView: React.FC<ReportsViewProps> = ({
  ...
  const handleDownload = () => {
    window.print();
    onTriggerToast('success', \`Security Report [\${reportRecord.caseId}.pdf] generated and queued for download.\`);
  };
  ...
  const tamperingDetected = reportRecord.pipelineResults?.tamperingDetection === 'warning' || reportRecord.findings.some(f => f.category === 'tampering');
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white p-8 sm:p-12 rounded-2xl border border-slate-300 shadow-lg text-slate-900 font-sans space-y-8">
...
console.log("Updated report view successfully");
